...
<body
	...
	<!-- Content -->
	<section class="content"> <!-- Page header --> <section
		class="browse-header"> </section><!-- End Page header --> <!-- Page wrapper -->
	<div class="browse-wrapper">
		...
		<div class="browse-main-header-updated">
			...
			<ul class="browse-main-nav nav nav-tabs clearfix">
				...
				<li><a href="LiveStream.jsp">實況</a></li>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="livestreams">
				<div class="browse-main-items">
					<div id="livestream_items" class="browse-main-videos clearfix" style="width: 950px;">
<!-- 						<table> -->
<!-- 							<tr> -->
								<div class="browse-main-filters">
									...
									<button type="button" value="MusicVideo"
										...
										class="browse-main-filters--button js-browse-product-type ">音樂影片</button>
									<button type="button" value="News" id="browse_type_News"
										class="browse-main-filters--button js-browse-product-type ">新聞</button>
									<button type="button" value="Drama" id="browse_type_Drama"
										class="browse-main-filters--button js-browse-product-type ">戲劇</button>
									<button type="button" value="Animation"
										id="browse_type_Animation"
										class="browse-main-filters--button js-browse-product-type ">動畫</button>
									<button type="button" value="Daily" id="browse_type_Daily"
										class="browse-main-filters--button js-browse-product-type ">生活</button>
									<button type="button" value="Interest"
										id="browse_type_Interest"
										class="browse-main-filters--button js-browse-product-type ">趣味</button>
									<button type="button" value="Other" id="browse_type_Other"
										class="browse-main-filters--button js-browse-product-type ">其他</button>
								</div>
									<div id="videos_div1">
									<c:forEach var="list" items="${videolist}" varStatus="a">
<%-- 									<c:if test="${a.count%3==0}"> --%>
<!-- 										<tr> -->
<%-- 									</c:if> --%>
<!-- 										<td> -->
											<div class='service'>
