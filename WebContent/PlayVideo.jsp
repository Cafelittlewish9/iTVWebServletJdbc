...
<!-- 														<span style="font-family:Microsoft JhengHei;color:#767676;">v.memberId</span> -->
													...
													<p>
													  <button type="button" class="btn btn-primary btn-xs">Add Channel</button>
													</p>
												</div>
									...
									<div style="height:34px;text-align:left;margin:0px auto">
										<div >
											<a href="#"><span class="glyphicon glyphicon-plus" ><span style="font-family:Microsoft JhengHei;color:#167ac6;margin-right:10px">追加</span></span></a>
											<a href="#"><span class="glyphicon glyphicon-thumbs-up" ><span style="font-family:Microsoft JhengHei;color:#167ac6;margin-right:10px">讚</span></span></a>
											<a href="#"><span class="glyphicon glyphicon-bell" ><span style="font-family:Microsoft JhengHei;color:#167ac6;margin-right:10px">檢舉</span></span></a>
			...
			<!-- 	留言板 	-->
			<div class="col-md-6 col-md-offset-1" style="margin-top:10px;background:white;margin-left: 7.2222%;width: 90.333333%;">
				<div >
