...
// 		影片回覆
	  $('#comment_submit').click(function(){
		  $.ajax({
			  url:'VideoCommentServlet?videoId=2',
			  type:'GET',
				  ...
				  $.each(data.list, function(i, v) {
						  ...
						  $('#comment_page').append("<div class='row' style='margin-bottom: 15px'>" + 
						  								"<div class='col-lg-1' style='top: 8px'>" + 
						  									"<img src='data:image/jpg;base64," + v.member.memberNickname + "' style='width: 50px; height: 50px' />" + 
						  								"</div>" + 
						  								"<div class='col-lg-4'>" + 
						  									"<h5>" + 
						  										"<span style='color: #767676'>會員" + v.member.memberAccount + "XXX</span>" + 
						  									"</h5>" + 
						  									"<p>" + 
						...
						success:function(data){
							$.each(data,function(m,n){
								if(n.videoClassName==v.videoClassName){
				 					...
				 					var vn = n.videoName.substring(0,25);
				 					var vd = n.videoDescription;
				 					if(vd==null){
				 						vd="";
				 					}
				 					//順序=最新-舊
				 					if(10>=data.length-m){
				 					$('#P_div1').prepend("<div class='service' style='margin-bottom: 10px;'>"+"<div class='col-md-5' style='padding:5px 5px 0px 0px;'>"+
				 							     ...
				 							     "<a href='PlayVideo.jsp?filename="+n.videoName+"'>"+
				 							     "<span class='font-right'><div style='width:150px; display:inline-block' class='font-right'>"+vn+"</div></span></a><br>"+
				 							     "<span class='font-right'><div style='width:150px; display:inline-block' class='font-right'><p>"+vd+"</p></div></span></a><br>"+
				 							     "<div style='text-align:-webkit-auto;'><span class='font-right' id='v_watchtimes'>"+"觀看次數:"+n.videoWatchTimes+ "views</span></div><br>"+
				 							     "</div>");
				 					}
								}
...
// 		會員資訊
		$.ajax({
			...
			success:function(data){
				$.each(data,function(i,v){
						$('#info h4').append("<span style='color:#767676;'>"+v.videoName+"</span>");
						$('#info h5').append("<span style='color:#767676;'>"+v.memberId+"</span>");
				});	
			}
		})
	...
	<div class="row"
		...
		<div class="row" style="margin-top: 100px; width: 800px; float: left">
			...
			<div class="col-md-6 col-md-offset-1"
				...
				<video id="example_video_1" class="video-js vjs-default-skin"
					controls preload="none" width="100%" height="400"
					data-setup='{"techOrder": ["html5", "flash"] }' preload="auto"
					poster="" autoplay="autoplay"> <source
					src="../mp4/<%=name%>.mp4" type='video/mp4' /> </video>
				...
				<div style="height: 34px; text-align: left; margin: 0px auto">
					<div>
						<a href="#"><span class="glyphicon glyphicon-plus"><span
								style="font-family: Microsoft JhengHei; color: #167ac6; margin-right: 10px">追加</span></span></a>
						<a href="#"><span class="glyphicon glyphicon-thumbs-up"><span
								style="font-family: Microsoft JhengHei; color: #167ac6; margin-right: 10px">讚</span></span></a>
						<a href="#"><span class="glyphicon glyphicon-bell"><span
								style="font-family: Microsoft JhengHei; color: #167ac6; margin-right: 10px">檢舉</span></span></a>
		...
		<div class="col-md-3"
			...
			<div style="height: 68px; text-align: left; margin: 0px auto">
				<div style="padding-top: 5px">
					<h4>
						<span style="font-family: Microsoft JhengHei; color: #767676;">あなたへのおすす</span>
					</h4>
				</div>
			</div>
			...
			<div id="P_div1">
				...
				<!-- 									<div class="col-md-5"> -->
				<!-- 											<a href='PlayVideo.jsp?filename=Attack'><img src="img/Attack.jpg" style="width:120px;height:68px"/></a> -->
				<!-- 									</div> -->
				<!-- 									<div class="col-md-7" style="padding-left: 5px;"> -->
				<!-- 											<a style='text-decoration:none;color:#333;font-weight: bold;font-family:Microsoft JhengHei; font-size:18px' href='PlayVideo.jsp?filename=Attack'><span style="">Attack</span></a><br> -->

				<!-- 											<span style="font-family:Microsoft JhengHei;color:#767676;font-size:10px">上傳者:</span><br> -->

				<!-- 											<span style="font-family:Microsoft JhengHei;color:#767676;font-size:10px">觀看次數:</span><br> -->
